      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <button
            ...
            className="flex items-center gap-2 text-blue-500 hover:text-blue-700 mb-3 text-sm md:text-base"
          >
            <ArrowLeft size={18} />
            Volver
          </button>
        ...
        >
          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              {archivo && (
                <span className="text-xs md:text-sm text-gray-600 break-all">{archivo.name}</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="button"
              onClick={() => navigate('/contactos')}
              className="flex-1 bg-gray-300 text-gray-800 py-2 md:py-3 rounded-lg font-semibold hover:bg-gray-400 transition text-sm md:text-base"
            >
              Cancelar
            </button>
          </div>
